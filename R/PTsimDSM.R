...
#' Each row of the binary matrix \code{x} represents a focal element from one simDSM that is *not* the entire SSR.  
...
#'
#' @param x A binary matrix where each row represents a focal element that is not the full SSR.
