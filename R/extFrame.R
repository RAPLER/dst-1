...
#' 
#' @param z An object of bca class, i.e. a basic chance assignment defined on one variable
...
#' @export
#' @examples 
#' s1_e1 <- bca(tt = matrix(c(1,0,1,1),nrow = 2, byrow = TRUE), m = c(0.6,0.4), cnames = c("S1","S2"), varnames = "v1", idvar = 1) 
