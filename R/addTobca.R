...
#' @param x A basic chance assignment mass function (see \code{\link{bca}}). It can also be the normalized result of the combination of two mass functions by Dempster's Rule.
