...
test_that("mobiusInvHQQ", {
  ...
  expect_equal(z$spec[1,2], mobiusInvHQQ(w$qq, c(0,0,0)))
  expect_equal(z$spec[2,2], mobiusInvHQQ(w$qq, c(1,0,0)))
  expect_equal(0, mobiusInvHQQ(w$qq, c(0,1,0)))
  expect_equal(0, mobiusInvHQQ(w$qq, c(0,0,1)))
  expect_equal(z$spec[3,2], mobiusInvHQQ(w$qq, c(0,1,1)))
  expect_equal(z$spec[4,2], mobiusInvHQQ(w$qq, c(1,1,0)))
  expect_equal(0, mobiusInvHQQ(w$qq, c(1,0,1)))
  expect_equal(z$spec[5,2], mobiusInvHQQ(w$qq, c(1,1,1)))
})
