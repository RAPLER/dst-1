...
qt <- 0.25
v <- c("a","b","c","d")
x<-bca(matrix(c(1,1,1,0,1,1,1,1), nrow=2, byrow=TRUE), m=c(a,1-a), cnames=v)
y<-bca(matrix(c(0,1,1,0,1,1,1,1), nrow=2, byrow=TRUE), m=c(a*fr,1-a*fr), cnames=v)
z<-bca(matrix(c(1,0,1,0,1,1,1,1), nrow=2, byrow=TRUE), m=c(a*fr,1-a*fr), cnames=v)
w1<-dsrwon(x, y, use_ssnames = TRUE)
bcaPrint(w1)
w2<-dsrwon(w1, z, use_ssnames = TRUE)
bcaPrint(w2)
