...
* how to specify a relation *r* between two variables *A* and *B* by way of a mass function *m* on some subsets of the set of possible values of the product space *AxB* (function *bcaRel*);
...
Thirdly, narginalize to the variable Roadworks.
