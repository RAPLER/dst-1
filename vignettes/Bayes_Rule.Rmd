...
This distribution will be encoded in the product space $\Theta \cdot \Lambda$ by setting 
...
Now we combine Prior $P(X)$ with rel_EX. But first, we need to extent *X* to the space $\Theta \cdot \Lambda$.
...
bcaPrint(X_xtnd)
```
Combine X extended and E_X in the product space $\Theta \cdot \Lambda$.
...
1. the distribution of the product $P(H) \cdot P(E|H)$ on $\Theta \cdot \Lambda$;
